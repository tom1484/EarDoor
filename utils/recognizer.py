...
class Recognizer:
    ...
    def detect(self, frame, displayFrame):
        rW = displayFrame.shape[1] / frame.shape[1]
        rH = displayFrame.shape[0] / frame.shape[0]
        ...
        for (x, y, w, h) in ear:
            ...
            displayFrame = cv2.rectangle(displayFrame, (x, y), (x + w, y + h), (255, 0, 0), 2)
            cv2.putText(displayFrame, self.names[params[0]], (x, y - 35), cv2.FONT_HERSHEY_SIMPLEX, 0.8, (255, 0, 0), 2)
